 ...
 *			</ul>
 *
 * @note	The APIs listed in this file are under the license control of "App" module in PDF SDK.<br>
 *			Please make sure the license of App module is purchased and apply the license before 
...
{
	FS_DWORD	flags;	/**< @brief The note flags. Please refer to macro definitions <b>FSCRT_NOTEFLAG_XXX</b> and this should be one of these macros. */
