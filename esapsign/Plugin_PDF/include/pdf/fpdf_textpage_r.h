 ...
 *			</ul>
 *
 * @note	If you want to purchase Foxit PDF SDK license and use ANY of the following functions, please request for enabling PDFTextPage module explicitly.
 */
 ...
 *								Application should release this handle if not use by calling function ::FSPDF_TextPage_Release.
 *
 ...
 * @param[out]	charIndex		Pointer to a ::FS_INT32 object that receives the zero-based index of the character at, or nearby point (x,y).<br> 
