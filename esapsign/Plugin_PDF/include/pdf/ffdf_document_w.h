 ...
 *			</ul>
 *
 * @note	If you want to purchase Foxit PDF SDK license and use ANY of the following functions, please request for enabling FDFDocument module explicitly.
 */
 ...
 *
 * @param[in]	format		FDF document format type. Currently only ::FSCRT_DOCUMENTTPYE_FDF is supported.
 ...
 *			The function applies to the ::FSCRT_DOCUMENTTPYE_FDF document, which contains elements required to export or import interactive form data.
 *
 * @param[in]	fdfDoc		Handle to a <b>FSCRT_DOCUMENT</b> object which is a FDF document object.
