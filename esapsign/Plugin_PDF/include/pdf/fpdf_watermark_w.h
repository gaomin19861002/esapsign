 ...
 *
 * The following code is copyrighted and is the proprietary of Foxit Corporation. It's not allowed to 
 * distribute any parts of Foxit PDF SDK to third party or public without permission unless an agreement 
 * is signed between Foxit Corporation and customers to explicitly grant customers permissions.
 *
 ...
 *			</ul>
 *
 * @note	The APIs listed in this file are under the license control of "PDF Watermark" module in PDF SDK.<br>
 *			Please make sure the license of PDF Watermark module is purchased and apply the license before 
 ...
 *				Definitions and functions in this module are included in fpdf_watermark_w.h.<br>
 ...
 *				<li>1. Watermark:
 *					<ul>
 *					<li>a. Create a watermark from a text, image, bitmap or PDF page, retrieve watermark size, insert or remove a watermark.</li>
 *					<li>b. A watermark can be created as the content of a page directly, or be created as an annotation in a page.
 ...
 *					<li>c. Reference: it's described in section 8.4.5 of PDF Reference 1.7 about watermark annotation.</li>
 *					</ul>
 *				</li>
 *				</ul>
 */
...
typedef struct _FSPDF_WATERMARK_TEXTPROPERTIES
{
	...
	FS_FLOAT 	fontSize;
	/** @brief	Text color. It's constructed by 0xAARRGGBB.*/
	FS_ARGB		color;
	/** 
 ...
 * @param[out]	watermark		Pointer to a <b>FSPDF_WATERMARK</b> handle that receives the watermark handle.
 *
 ...
 * @param[out]	watermark		Pointer to a <b>FSPDF_WATERMARK</b> handle that receives a watermark handle.
 *
 * @return	::FSCRT_ERRCODE_SUCCESS for success.<br>
 ...
 *			::FSCRT_ERRCODE_NOTPARSED if the parameter<i>page</i> is not parsed when a watermark is inserted as page content.<br>
 * 			::FSCRT_ERRCODE_UNRECOVERABLE if an unrecoverable error occurs internally.<br>
 * 			::FSCRT_ERRCODE_OUTOFMEMORY if there is not enough memory or invalid memory access.<br>
 *			For more error codes, please refer to macro definitions <b>FSCRT_ERRCODE_XXX</b>.
 *
