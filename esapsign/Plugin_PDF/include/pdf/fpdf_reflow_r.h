 ...
 *			</ul>
 *
 * @note	If you want to purchase Foxit PDF SDK license and use ANY of the following functions, please request for enabling PDFReflow module explicitly.
 */
 ...
 *
 * @param[in]	pdfPage			Handle to a <b>FSCRT_PAGE</b> object which is a PDF page obejct.
...
/**
 * @brief	Set line space before callinging function ::FSPDF_ReflowPage_StartParse.
 *
 * @param[in]	reflowPage			Handle to a <b>FSPDF_REFLOWPAGE</b> object returned by function ::FSPDF_ReflowPage_Create.
