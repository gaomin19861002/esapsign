 ...
 *			</ul>
 *
 * @note	If you want to purchase Foxit PDF SDK license and use ANY of the following functions, please request for enabling PDFPage module explicitly.
 */
 ...
 *
 * @param[in]	page		Handle to a valid <b>FSCRT_PAGE</b> object.
 * @param[in]	width		A ::FS_FLOAT value for page width, unit is 1/72 inch. It should be greater 0.
 * @param[in]	height		A ::FS_FLOAT value for page height, unit is 1/72 inch. It should be greater 0.
 *
 * @return	::FSCRT_ERRCODE_SUCCESS if succeeded.<br>
...
/** @brief	Flatten contents for display. */
#define FSPDF_FLATTENFLAG_DISPLAY			0
/** @brief	Flatten contents for printing. */
 ...
 *							Please refer to macro definitions <b>FSPDF_FLATTENFLAG_XXX</b> and this should be one of these macros.
 *
 * @return	::FSCRT_ERRCODE_SUCCESS if succeeded.<br>
