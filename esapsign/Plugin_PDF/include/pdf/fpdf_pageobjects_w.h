 ...
 * @param[in]	mask			Handle to a <b>FSCRT_BITMAP</b> object which is a bitmap object for mask, and its format should be ::FSCRT_BITMAPFORMAT_8BPP_GRAY.
 *								This is valid only when parameter <i>bitmap</i> has an alpha channel.
 ...
 * 			::FSCRT_ERRCODE_UNSUPPORTED if format of parameter <i>mask</i> is not ::FSCRT_BITMAPFORMAT_8BPP_GRAY when <i>mask</i> is valid.<br>
