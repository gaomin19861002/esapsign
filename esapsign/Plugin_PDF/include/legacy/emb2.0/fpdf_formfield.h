...
{	
	 ...
	 *			Implementation should call ::FPDFEMB_RenderPage_Start function for repainting a specified page area.
	 *
	 * @param[in] clientData	Pointer to the interface structure itself.
 ...
 *			With '::FPDF_RENDER_ANNOT|::FPDF_RENDER_NOWIDGET' specified for flags, rendering functions (like ::FPDFEMB_RenderPage_Start) will only render page contents and annotations without widgets to a bitmap.
