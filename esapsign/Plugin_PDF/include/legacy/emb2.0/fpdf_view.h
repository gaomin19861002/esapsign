 ...
 *			::FPDFEMB_RenderPage_Start function.<br>
 ...
 *			The application should call ::FPDFEMB_RenderPage_Continue repeatedly to finish the rendering 
 ...
 *
 */
FS_RESULT FPDFEMB_RenderPage_Start(FS_BITMAP dib, FPDF_PAGE page,
 ...
 *			a pause is needed. The application can call ::FPDFEMB_RenderPage_Continue any number
 ...
 *
 */
FS_RESULT FPDFEMB_RenderPage_Continue(FPDF_PAGE page, FS_PAUSE* pause);
