 ...
 * 
 * @param[in]	file			Handle to a <b>FSCRT_FILE</b> object which is a file object.
 ...
 *			::FSCRT_ERRCODE_UNSUPPORTED if the parameter <i>imageType</i> indicating is ::FSCRT_IMAGETYPE_GIF.<br>
 ...
 * 
 * @details	Frame number shall match image type. For example, a TIF file supports multiple frames. 
 ...
 * 
 * @param[in]	imageFile		Handle to a <b>FSCRT_IMAGEFILE</b> object which is an image file object.
 * @param[in]	property		Pointer to a <b>FSCRT_BSTR</b> structure specifing a property of an image, such as "EXIF" info. 
 *								Currently only dpi property is supported. Please refer to macro definition ::FSCRT_IMAGEPROPERTY_DPI.
 * @param[in]	values			Pointer to a <b>FSCRT_VAR</b> structure which represents the value associated to some property.
