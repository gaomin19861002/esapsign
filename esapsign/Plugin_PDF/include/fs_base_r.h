 ...
 *			</ul>
 *
 * @note	The APIs listed in this file are under the license control of Base module in PDF SDK.<br>
 *			Please make sure the license of Base module is purchased and apply the license before 
...
/**
 * @brief	Macro to construct a byte string with constant string value.
 *
 * @note	Here are examples:<br>
 * @code
...
/**
 * @brief	Macro to initialize constant string value.
 *
 ...
 *			For more error codes, please refer to macro definitions <b>FSCRT_ERRCODE_XXX</b>.
 *
 * @note	The size of memory buffer is fixed:<br>
 *			For reading mode, the parameter <i>length</i> indicates the size of data stored in the parameter <i>buffer</i>.<br>
 *			For writing mode, the parameter <i>length</i> is the maximum size of data can be written.
 *
 * @attention	<b>Thread Safety</b>: this function is thread safe.<br>
 *				<b>OOM Information</b>:<br>
 *				OOM handling is only for mobile platforms, not for server or desktop.<br>
...
/** @brief	Write mode, create automatically if a file doesn't exist. */
...
/**
 * @brief	Set reading range of file object.
 *
 ...
 *
 * @return	::FSCRT_ERRCODE_SUCCESS for success.<br>
 *			::FSCRT_ERRCODE_PARAM if the parameter <i>file</i> or <i>offset</i> or <i>length</i> is <b>NULL</b>.<br>
 *			For more error codes, please refer to macro definitions <b>FSCRT_ERRCODE_XXX</b>.
 *
 * @attention	<b>Thread Safety</b>: this function is thread safe.<br>
 *				<b>OOM Information</b>:<br>
 ...
 * 
 * @details	If applications use Foxit PDF SDK in the expired condition, please contact Foxit Corporation to get a legal license. 
 */
 ...
 * @param[out]	x				Pointer to a ::FS_INT32 object that receives the value of the X coordinate of the point.
 * @param[out]	y				Pointer to a ::FS_INT32 object that receives the value of the Y coordinate of the point.
...
#define FSCRT_DOCUMENTTPYE_PDF			1
/** @brief	FDF document type. */
#define FSCRT_DOCUMENTTPYE_FDF			2
 ...
 *							Please refer to macro definitions <b>FSCRT_DOCUMENTTPYE_XXX</b> and this should be one of these macros.
 *
 * @return	::FSCRT_ERRCODE_SUCCESS for success.<br>
...
/**
 * @brief	Get a page handle related to an annotation.
 *
 ...
 * @param[out]	pause		Pointer to a ::FSCRT_PAUSEHANDLER structure to determine break state.<br>
 ...
 *
 * @param[in]	fontFile		Handle to a <b>FSCRT_FILE</b> object.
 * @param[in]	faceIndex		The zero-based face index, range from [0, face_count).
 ...
 *
 * @return	::FSCRT_ERRCODE_SUCCESS for success.<br>
 *			::FSCRT_ERRCODE_PARAM if the parameter <i>fontFile</i>, <i>font</i> is <b>NULL</b> or the <i>faceIndex</i> is less than zero.<br>
 * 			::FSCRT_ERRCODE_UNRECOVERABLE if an unrecoverable error occurs.<br>
 * 			::FSCRT_ERRCODE_OUTOFMEMORY if there is not enough memory or invalid memory access.<br>
