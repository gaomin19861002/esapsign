 ...
 *			</ul>
 *
 * @note	The APIs listed in this file are under the license control of "Barcode" module in PDF SDK.<br>
 *			Please make sure the license of Barcode module is purchased and apply the license before 
 ...
 *			For more error codes, please refer to macro definitions <b>FSCRT_ERRCODE_XXX</b>.
 * 
 * @note	::FSCRT_BCModule_Initialize should be called to initialize barcode module before any functions of barcode module are called.
 *
 * @attention	<b>Thread Safety</b>: this function is thread safe.<br>
 *				<b>OOM Information</b>:<br>
 *				OOM handling is only for mobile platforms, not for server or desktop.<br>
